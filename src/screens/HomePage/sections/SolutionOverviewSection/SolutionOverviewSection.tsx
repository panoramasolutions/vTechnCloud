...
export const SolutionOverviewSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-[60px] py-32 px-5 sm:px-8 w-full bg-white">
      <div className="flex flex-col max-w-[1204px] items-center gap-[60px] w-full">
        ...
        <header className="flex flex-col max-w-[800px] items-center gap-8 w-full">
          <div className="flex flex-col items-center gap-4 w-full">
            ...
            <p className="max-w-[820px] text-center opacity-80 font-body-base-regular text-[#4b5162] px-5">
              Advanced business intelligence tools enhance efficiency across
              your entire operation. By predicting future revenue and dissecting
        ...
        <div className="w-full">
          ...
          <div className="hidden sm:flex flex-wrap justify-center gap-8 w-full pb-20 relative">
              ...
              >
                <CardContent className="flex flex-col items-start gap-4 p-8">
                  <img
                    ...
                    src={card.image}
                  />
                  <div className="flex flex-col h-[110px] items-start gap-1 w-full">
                  ...
                  <div className="flex items-center gap-1 text-[#387ff5] font-body-sm-regular">
                    {card.category}
            ...
            <div className="flex flex-col w-full items-center justify-center mt-8">
              <Button
                variant="outline"
                className="bg-[#ffffff1a] backdrop-blur-[6px] border border-solid border-[#b6bbcd] rounded-xl"
              >
          ...
          {/* Mobile: grid */}
          <div className="grid sm:hidden grid-cols-1 gap-8 w-full pb-20">
            {solutionCards.map((card, index) => (
              <Card
                key={index}
              ...
              >
                <CardContent className="flex flex-col gap-4 p-8">
                  <img
                    ...
                    src={card.image}
                  />
                  <div className="flex flex-col h-[110px] gap-1">
                    <h5 className="font-heading-desktop-h5-bold text-[#1c1f25]">
                      {card.title}
                    </h5>
                    <p className="opacity-80 font-body-base-regular text-[#4b5162]">
                      {card.description}
                ...
                <CardFooter className="px-8 pb-8 pt-0 flex items-center gap-2">
                  <span className="font-body-sm-regular text-[#387ff5]">
                    {card.category}
                  </span>
                  <ArrowRightIcon className="w-[11.03px] h-[10.74px] text-[#387ff5]" />
                </CardFooter>
              </Card>
            ))}
            <div className="flex flex-col w-full items-center justify-center mt-8">
